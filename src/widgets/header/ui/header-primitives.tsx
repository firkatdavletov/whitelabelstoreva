  ...
  return (
    <Link className="flex min-w-0 items-center gap-3" href={href}>
      {logoUrl ? (
        <img
          alt={logoText}
          className="h-11 w-auto max-w-32 shrink-0 object-contain"
          src={logoUrl}
        />
      ) : (
        <span className="bg-card border-border/70 text-foreground flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-2xl border text-sm font-semibold tracking-[0.24em] shadow-sm">
